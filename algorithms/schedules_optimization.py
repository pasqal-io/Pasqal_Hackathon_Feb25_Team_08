...
from algorithms.cost_function import cost
import cma
import tqdm
...
def objective(omega, delta, T, reg):
    """
    ...
    energy = cost(counts_dict)

    return energy


def schedule_optimizer(omega_max, delta_max, l1, l2, T, reg):
    """
    ...
    for _ in pbar:
        ...
        costs = [objective(omega, delta, T, reg) for omega, delta in zip(solutions_omega, solutions_delta)]
